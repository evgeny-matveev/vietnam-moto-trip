...
const nhaTrangStays = [
  stay("special", {
    ...
    caution:
      "От центра Нячанга (Nha Trang) около 18 км. Прежде чем отказаться от пляжа, подтвердите три подходящих номера на обе ночи.",
    mapNote:
  ...
  4: plan(
    ...
    [
      ...
      stay("luxury", {
        ...
        why: "Самый комфортный вариант прямо на озере Лак (Lắk), сохранивший лодочный трансфер и тишину лагеря.",
  ...
  10: plan(
    ...
    [
      stay("special", {
        ...
        mapNote: "Метка указывает на деревню Гоко (Gò Cỏ); точный дом хозяина уточните до приезда.",
